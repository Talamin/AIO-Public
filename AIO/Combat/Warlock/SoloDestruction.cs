...
namespace AIO.Combat.Warlock
{
    ...
    internal class SoloDestruction : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Death Coil"), 3.8f, (s,t) => (!t.IsStunned && Me.IsInGroup && BossList.isboss && t.HealthPercent > 20) || (Me.HealthPercent < 35 && !t.IsStunned), RotationCombatUtil.BotTarget),
