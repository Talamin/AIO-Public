...
namespace AIO.Combat.Warlock
{
    ...
    internal class SoloDestruction : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Curse of the Elements"), 3.2f, (s,t) => t.HealthPercent > 35 && !t.HaveBuff("Curse of the Elements"), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Shadowfury"), 3.5f, (s,t) => Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.SoloDestructionAOECount && Settings.Current.SoloDestructionUseAOE, RotationCombatUtil.BotTargetFast, checkLoS: true),
            new RotationStep(new RotationSpell("Rain of Fire"), 3.6f, (s,t) => Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.SoloDestructionAOECount && Settings.Current.SoloDestructionUseAOE, RotationCombatUtil.BotTargetFast, checkLoS: true),
