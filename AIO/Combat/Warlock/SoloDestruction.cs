...
namespace AIO.Combat.Warlock
{
    ...
    internal class SoloDestruction : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Corruption"), 4f, (s,t) => !t.HaveMyBuff("Corruption") && t.HealthPercent > Settings.Current.UseWandTresh && t.IsElite, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Immolate"), 5f, (s,t) => !t.HaveMyBuff("Immolate") && t.HealthPercent > Settings.Current.UseWandTresh, RotationCombatUtil.BotTarget),
