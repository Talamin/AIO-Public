...
namespace AIO.Combat.Warlock
{
    ...
    internal class SoloDestruction : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Death Coil"), 3.8f, (s,t) => (!t.IsStunned && Me.IsInGroup && BossList.MyTargetIsBoss && t.HealthPercent > 20) || (Me.HealthPercent < 35 && !t.IsStunned), RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Shadowfury"), 3.5f, (s,t) => (RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10 && o.IsElite) >= 2) || (BossList.MyTargetIsBoss && !t.IsStunned), RotationCombatUtil.BotTarget),
