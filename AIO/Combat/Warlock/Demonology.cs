...
namespace AIO.Combat.Warlock
{
    ...
    internal class Demonology : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Metamorphosis"), 3f, (s,t) => !Me.HaveBuff("Metamorphosis") && Settings.Current.Metamorphosis =="OnCooldown", RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Metamorphosis"), 3.1f, (s,t) => !Me.HaveBuff("Metamorphosis") && Settings.Current.Metamorphosis =="OnBosses" && t.IsBoss, RotationCombatUtil.FindMe),
            ...
            new RotationStep(new RotationSpell("Life Tap"), 5f, (s,t) => Me.HealthPercent > 50 && Me.ManaPercentage < Settings.Current.Lifetap,RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Corruption"), 8f, (s,t) => Me.IsInGroup &&  !t.HaveMyBuff("Seed of Corruption") && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.AOEInstance && Settings.Current.UseAOE, RotationCombatUtil.FindEnemy),
            new RotationStep(new RotationSpell("Rain of Fire"), 6f, (s,t) => Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.AOEInstance && Settings.Current.UseAOE, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Health Funnel"), 7f, (s,t) => !Pet.HaveBuff("Health Funnel") && Pet.HealthPercent < Settings.Current.HealthfunnelPet && Me.HealthPercent > Settings.Current.HealthfunnelMe && Pet.IsAlive && Pet.IsMyPet, RotationCombatUtil.FindPet),
