...
namespace AIO.Combat.Warlock
{
    ...
    internal class GroupAffliction : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Corruption"), 8f, (s,t) => Settings.Current.GroupAfflictionSpreadCorruption && _enemiesWithoutMyCorr.Count > 0, _enemiesWithoutMyCorr.FirstOrDefault),
            new RotationStep(new RotationSpell("Unstable Affliction"), 8.5f, (s,t) => Settings.Current.GroupAfflictionSpreadUnstableAffliction && _enemiesWithoutMyUA.Count > 0, _enemiesWithoutMyUA.FirstOrDefault),
            new RotationStep(new RotationSpell("Curse of Agony"), 9f, (s,t) => Settings.Current.GroupAfflictionAfflCurse == "Agony" && Settings.Current.GroupAfflictionSpreadCurseOfAgony && _enemiesWithoutMyCOA.Count > 0, _enemiesWithoutMyCOA.FirstOrDefault),

            new RotationStep(new RotationSpell("Unstable Affliction"), 9.1f, (s,t) => !t.CHaveMyBuff("Unstable Affliction"), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Corruption"), 9.2f, (s,t) => !t.CHaveMyBuff("Corruption"), RotationCombatUtil.BotTarget),
