...
namespace AIO.Combat.Rogue
{
    ...
    internal class GroupAssassination : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep>
        {
            ...
            new RotationStep(new RotationSpell("Vanish"), 7f, (s,t) => _comboPoints >= 1 && BossList.MyTargetIsBoss, RotationCombatUtil.BotTargetFast), // trigger Overkill
            new RotationStep(new RotationSpell("Cold Blood"), 8f, (s,t) => _comboPoints >= 4, RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Envenom"), 9f, (s,t) => _comboPoints >= 4, RotationCombatUtil.BotTargetFast),
            ...
            new RotationStep(new RotationSpell("Slice and Dice"), 11f, (s,t) => !Me.CHaveBuff("Slice and Dice"), RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Rupture"), 12f, (s,t) => !Me.CHaveBuff("Hunger For Blood") && !t.CHaveMyBuff("Rupture"), RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Mutilate"), 13f, (s,t) => _comboPoints < 4, RotationCombatUtil.BotTargetFast),
            // Lower levels
            new RotationStep(new RotationSpell("Eviscerate"), 14f, (s,t) => !_knowEnvenom && _comboPoints >= 3, RotationCombatUtil.BotTargetFast),
