...
namespace AIO.Combat.Shaman
{
    ...
    internal class SoloElemental : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Healing Wave"), 4f, (s,t) => Me.HealthPercent < 50, RotationCombatUtil.FindMe, preventDoubleCast: true),
            new RotationStep(new RotationSpell("Wind Shear"), 15f, (s,t) => t.IsTargetingMeOrMyPetOrPartyMember, RotationCombatUtil.FindEnemyCasting),
            new RotationStep(new RotationSpell("Flame Shock"), 16f, (s,t) => t.IsTargetingMeOrMyPetOrPartyMember && Settings.Current.SoloElementalFlameShock && !t.HaveMyBuff("Flame Shock"), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Earth Shock"), 16.1f, (s,t) => t.IsTargetingMeOrMyPetOrPartyMember && Settings.Current.SoloElementalEarthShock && !t.HaveMyBuff("Earth Shock"), RotationCombatUtil.BotTarget),
