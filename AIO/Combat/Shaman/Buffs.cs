...
namespace AIO.Combat.Shaman
{
    ...
    internal class Buffs : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Call of the Elements"), 11f, (s,t) => Settings.Current.UseCotE && !MovementManager.InMovement && Totems.MissingDefaults() && !Totems.HasTemporary(), RotationCombatUtil.FindMe),

            new RotationStep(new RotationSpell("Mana Tide Totem"), 20f, (s,t) => Me.ManaPercentage <= 30, RotationCombatUtil.FindMe),
