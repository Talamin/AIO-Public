...
namespace AIO.Combat.DeathKnight
{
    ...
    internal class GroupBloodTank : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            //Taunt Offtargets
            new RotationStep(new RotationSpell("Auto Attack"), 1f, (s,t) => !Me.IsCast && !RotationCombatUtil.IsAutoAttacking(), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Dark Command"), 1.1f, (s,t) => Me.IsInGroup &&  RotationFramework.Enemies.Count(o => !o.IsTargetingMe && o.IsTargetingPartyMember) >=1, RotationCombatUtil.FindEnemyAttackingGroup),
            ...
            new RotationStep(new RotationSpell("Blood Boil"), 16f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) > Settings.Current.SoloBloodBloodBoil, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Death Strike"), 17f, RotationCombatUtil.Always, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Death Coil"), 18f, (s,t) => Me.RunicPower >= 40, RotationCombatUtil.BotTarget)
        };
    }
}
