...
namespace AIO.Combat.DeathKnight
{
    ...
    internal class SoloFrost : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Death and Decay"), 5f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance < 15) >= Settings.Current.SoloFrostDnD, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Blood Strike"), 12f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) == Settings.Current.SoloFrostBloodStrike, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Heart Strike"), 13f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) >= Settings.Current.SoloFrostHearthStrike, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Blood Boil"), 14f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) > Settings.Current.SoloFrostBloodBoil, RotationCombatUtil.BotTarget),
