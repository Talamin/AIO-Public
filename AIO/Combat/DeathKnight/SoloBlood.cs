...
namespace AIO.Combat.DeathKnight
{
    ...
    internal class SoloBlood : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Dark Command"), 1.1f, (s,t) => Me.IsInGroup && Settings.Current.SoloBloodDarkCommand &&  RotationFramework.Enemies.Count(o => !o.IsTargetingMe && o.IsTargetingPartyMember) >=1, RotationCombatUtil.FindEnemyAttackingGroup),
            new RotationStep(new RotationSpell("Death Grip"), 1.2f, (s,t) => Settings.Current.SoloBloodDeathGrip && Me.IsInGroup && RotationFramework.Enemies.Count(o => !o.IsTargetingMe && o.IsTargetingPartyMember) >=1,RotationCombatUtil.FindEnemyAttackingGroup),
            ...
            new RotationStep(new RotationSpell("Death Grip"), 2.2f, (s,t) => Settings.Current.SoloBloodDeathGrip && t.IsCast && t.IsTargetingMeOrMyPetOrPartyMember && t.GetDistance < 20, RotationCombatUtil.FindEnemyCasting),
            ...
            new RotationStep(new RotationSpell("Mark of Blood"), 6f, (s,t)  => BossList.MyTargetIsBoss ||(t.IsElite && Me.IsInGroup), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Dancing Rune Weapon"), 7f, (s,t)  => BossList.MyTargetIsBoss ||(t.IsElite && !Me.IsInGroup) || (RotationFramework.Enemies.Count(o => o.GetDistance <= 10) >=2 && !Me.IsInGroup), RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Blood Strike"), 13f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) == Settings.Current.SoloBloodBloodStrike, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Heart Strike"), 14f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) >= Settings.Current.SoloBloodHearthStrike, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Blood Boil"), 15f, (s,t) => RotationFramework.Enemies.Count(o => o.GetDistance <= 10) > Settings.Current.SoloBloodBloodBoil, RotationCombatUtil.BotTarget),
