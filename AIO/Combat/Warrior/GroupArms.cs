...
namespace AIO.Combat.Warrior
{
    ...
    internal class GroupArms : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep>
        {
            ...
            // Rage dumps
            new RotationStep(new RotationSpell("Cleave"), 4f, (s,t) => Me.CRage() > 50 && !_cleaveOn && !_heroicStrikeOn && _cleavableEnemies.Count > 0 && _nbEnemiesAroundMe >= Settings.Current.GroupArmsAoe, RotationCombatUtil.BotTargetFast, ignoreGCD: true),
            ...
            new RotationStep(new RotationSpell("Enraged Regeneration"), 10f, (s,t) => Me.CHealthPercent() < Settings.Current.GroupArmsEnragedRegen, RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Berserker Rage"), 11f, (s,t) => Me.CHaveBuff("Fear"), RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Demoralizing Shout"), 12f, (s,t) => Settings.Current.GroupArmsDemoShout && !t.CHaveBuff("Demoralizing Shout"), RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Intimidating Shout"), 13f, (s,t) => Settings.Current.GroupArmsIntimShout && _nbEnemiesAroundMeCasting > 0, RotationCombatUtil.BotTargetFast),
            ...
            new RotationStep(new RotationSpell("Slam"), 19f, (s,t) => Settings.Current.GroupArmsSlam && Me.CRage() > 20, RotationCombatUtil.BotTargetFast),
