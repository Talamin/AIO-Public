...
namespace AIO.Combat.Warrior
{
    ...
    internal class GroupFury : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Intercept"), 12f, (s,t) => KnowIntercept && Settings.Current.GroupFuryIntercept && Me.CRage() > 10 && t.CGetDistance() > 7 && t.CGetDistance() <= 24, RotationCombatUtil.BotTargetFast),
            new RotationStep(new RotationSpell("Charge"), 13f, (s,t) => !KnowIntercept && Settings.Current.GroupFuryIntercept && t.CGetDistance() > 7, RotationCombatUtil.BotTarget),
