...
namespace AIO.Combat.Paladin
{
    ...
    internal class GroupProtectionTank : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Consecration"), 2f, RotationCombatUtil.Always, _ => EnemiesAttackingGroup.Count(unit => unit.CGetDistance() <=8) >= Settings.Current.ProtConsecration, RotationCombatUtil.FindMe, checkRange: false),
