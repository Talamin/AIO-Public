...
namespace AIO.Combat.Paladin
{
    ...
    internal class GroupHoly : HealerRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Purify"), 5f, (s,t) => Settings.Current.GroupHolyPurify, p => RotationCombatUtil.GetPartyMemberWithCachedDebuff(new List<DebuffType>() { DebuffType.Disease, DebuffType.Poison } , true, 30)),
            ...
            new RotationStep(new RotationSpell("Holy Light"), 9f, (s,t) => t.HealthPercent <= Settings.Current.GroupHolyHL, RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationSpell("Holy Light"), 9.1f, (s,t) => t.HealthPercent <= Settings.Current.GroupHolyHL, RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Flash of Light"), 10f, (s,t) => t.HealthPercent <= Settings.Current.GroupHolyFL, RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationSpell("Flash of Light"), 10.1f, (s,t) => t.HealthPercent <= Settings.Current.GroupHolyFL, RotationCombatUtil.FindMe),
