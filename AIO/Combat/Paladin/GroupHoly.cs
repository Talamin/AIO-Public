...
namespace AIO.Combat.Paladin
{
    ...
    internal class GroupHoly : HealerRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Purify"), 5f, (s,t) => Settings.Current.GroupHolyPurify, p => RotationCombatUtil.GetPartyMemberWithCachedDebuff(p, new List<DebuffType>() { DebuffType.Disease, DebuffType.Poison } , true, 30)),
