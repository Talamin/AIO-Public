...
namespace AIO.Combat.Paladin
{
    ...
    internal class NewBuffs : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationBuff("Seal of Righteousness"), 1.2f, (s, t) => Spec == "Retribution" && Settings.Current.Sealret == "Seal of Righteousness", RotationCombatUtil.FindMe),
            new RotationStep(new RotationBuff("Seal of Righteousness"), 2f, (s, t) => Spec == "Holy" && Me.Level < 38, RotationCombatUtil.FindMe),
            new RotationStep(new RotationBuff("Seal of Righteousness"), 2.1f, (s, t) => Spec == "Group Holy" && Me.Level < 38, RotationCombatUtil.FindMe),
            ...
            new RotationStep(new RotationBuff("Seal of Wisdom"), 5.1f, (s, t) => Spec == "Group Holy" && Me.Level >= 38, RotationCombatUtil.FindMe),
