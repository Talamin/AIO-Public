...
namespace AIO.Combat.Paladin
{
    ...
    internal class HealOOC : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            new RotationStep(new RotationSpell("Holy Light"), 3f, (s,t) => t.HealthPercent < 60 && (_settings.ChooseRotation == "GroupHolyHeal" || _settings.ChooseRotation == "Heal"), RotationCombatUtil.FindPartyMember),
