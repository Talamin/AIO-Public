...
namespace AIO.Combat.Paladin
{
    ...
    internal class GroupProtection : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Divine Shield"), 1.2f, (s,t) => Me.HealthPercent < Settings.Current.GroupProtectionLoH && !Me.CHaveBuff("Forbearance"), RotationCombatUtil.FindMe, checkRange: false),
            ...
            new RotationStep(new RotationSpell("Holy Wrath"), 12.5f, (s,t) => EnemiesAttackingGroup.ContainsAtLeast(u => u.CGetDistance() < 10 && u.IsElite && (u.IsCreatureType("Undead") || u.IsCreatureType("Demon")) && !u.IsStunned, 2), RotationCombatUtil.BotTargetFast),
