...
namespace AIO.Combat.Paladin
{
    ...
    internal class Buffs : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationBuff("Devotion Aura"), 8f, (s,t) => Settings.Current.Aura =="Crusader Aura" && Settings.Current.Aura != "Retribution Aura" && !Me.IsMounted && !Me.IsOnTaxi, RotationCombatUtil.FindMe),
            new RotationStep(new RotationBuff("Retribution Aura"), 8.1f, (s,t) => Settings.Current.Aura =="Retribution Aura", RotationCombatUtil.FindMe),
