...
namespace AIO.Combat.Paladin
{
    ...
    internal class Protection : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Consecration"), 2f, (s,t) => t.HealthPercent > 25 && RotationFramework.Enemies.Count(o => o.GetDistance <=15) >= Settings.Current.GeneralConsecration, RotationCombatUtil.BotTarget),
