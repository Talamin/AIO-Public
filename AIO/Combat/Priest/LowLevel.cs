...
namespace AIO.Combat.Priest
{
    ...
    internal class LowLevel : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Power Word: Shield"), 4f, (s,t) => Me.IsInGroup && t.HealthPercent < Settings.Current.ShadowUseShieldTresh && !t.HaveBuff("Power Word: Shield") && Settings.Current.ShadowUseShieldParty, RotationCombatUtil.FindPartyMember),
            ...
            new RotationStep(new RotationSpell("Lesser Heal"), 6f, (s,t) => Me.IsInGroup && !t.HaveMyBuff("Lesser Heal") && Me.HealthPercent < Settings.Current.ShadowUseFlashTresh && Settings.Current.ShadowUseHeaInGrp, RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Renew"), 7f, (s,t) =>  Me.HealthPercent < 90 && !Me.HaveBuff("Renew") , RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Renew"), 8f, (s,t) => Me.IsInGroup && !t.HaveMyBuff("Renew") && t.HealthPercent < Settings.Current.ShadowUseRenewTresh && Settings.Current.ShadowUseHeaInGrp, RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Flash Heal"), 9f, (s,t) => Me.IsInGroup && Me.HealthPercent < Settings.Current.ShadowUseFlashTresh && Settings.Current.ShadowUseHeaInGrp, RotationCombatUtil.FindMe),
