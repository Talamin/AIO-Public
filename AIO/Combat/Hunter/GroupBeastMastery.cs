...
namespace AIO.Combat.Hunter
{
    ...
    internal class GroupBeastMastery : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Bestial Wrath"), 10f, (s,t) => BossList.MyTargetIsBoss || EnemiesAttackingGroup.Count() > 3, RotationCombatUtil.BotTargetFast, checkLoS: true),
            new RotationStep(new RotationSpell("Rapid Fire"), 11f, (s,t) => BossList.MyTargetIsBoss || EnemiesAttackingGroup.Count() > 3, RotationCombatUtil.BotTargetFast, checkLoS: true),
