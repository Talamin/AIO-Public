    ...
    internal class Marksmanship : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationBuff("Rapid Fire"), 7f, (s,t) =>(RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPet) >=3 && !Me.IsInGroup) 
                    || (RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember) >= Settings.Current.AOECount && Me.IsInGroup) 
            ...
            new RotationStep(new RotationSpell("Volley"), 9.1f, (s,t) => RotationFramework.Enemies.Count(o => o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.AOECount && Settings.Current.UseAOE, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Arcane Shot"), 14f, (s,t) => t.GetDistance >= 5 && Settings.Current.MarksmanArcaneShot, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Multi-Shot"), 15f, (s,t) => t.GetDistance >= 5 && Settings.Current.MultiS && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember) >= Settings.Current.MultiSCount, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Aimed Shot"), 15.1f, (s,t) => t.GetDistance >= 5 && Settings.Current.MarksmanAimedShot, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Disengage"), 18f, (s,t) => t.GetDistance < 5 && t.IsTargetingMe && Pet.IsAlive && Settings.Current.Dis, RotationCombatUtil.BotTarget),
        };
    }
}
