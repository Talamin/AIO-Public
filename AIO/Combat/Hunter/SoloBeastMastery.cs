...
namespace AIO.Combat.Hunter
{
    ...
    internal class SoloBeastMastery : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Volley"), 4f, (s,t) => RotationFramework.Enemies.Count(o => o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.SoloBeastMasteryAOECount && Settings.Current.SoloBeastMasteryUseAOE, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Rapid Fire"), 11f, (s,t) => (RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPet) >= Settings.Current.SoloBeastMasteryAOECount && !Me.IsInGroup)||  (RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember) >= Settings.Current.SoloBeastMasteryAOECount && Me.IsInGroup)  || (t.IsElite && !Me.IsInGroup) || (Me.IsInGroup && t.IsBoss), RotationCombatUtil.FindMe),
            ...
            new RotationStep(new RotationSpell("Multi-Shot"), 15f, (s,t) => t.GetDistance >= 5 && Settings.Current.SoloBeastMasteryMultiS && RotationFramework.Enemies.Count(o => o.IsAttackable && o.IsTargetingMeOrMyPetOrPartyMember) >= Settings.Current.SoloBeastMasteryMultiSCount, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Disengage"), 17f, (s,t) => t.GetDistance < 5 && t.IsTargetingMe && Pet.IsAlive && Settings.Current.SoloBeastMasteryDis, RotationCombatUtil.BotTarget),
        };
    }
}
