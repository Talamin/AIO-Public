...
namespace AIO.Combat.Druid
{
    ...
    internal class Buffs : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            new RotationStep(new RotationBuff("Mark of the Wild"), 1f, (s,t) => !Me.IsMounted && !t.HaveBuff("Gift of the Wild") && !t.HaveBuff("Stamina") && !t.HaveBuff("Armor") && !t.HaveBuff("Agility")  && !t.HaveBuff("Strength"), RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationBuff("Mark of the Wild"), 2f, (s,t) =>!Me.IsMounted && !t.HaveBuff("Gift of the Wild") && !t.HaveBuff("Stamina") && !t.HaveBuff("Armor") && !t.HaveBuff("Agility") && !t.HaveBuff("Strength"), RotationCombatUtil.FindMe),
