...
namespace AIO.Combat.Druid
{
    ...
    internal class HealOOC : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            new RotationStep(new RotationSpell("Rejuvenation"), 1f, (s,t) => Spec =="FeralCombat" && Me.HealthPercent <= Settings.Current.OOCRejuvenation && Me.ManaPercentage > 15 && !Me.HaveBuff("Rejuvenation"), RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Regrowth"), 2f, (s,t) => Spec =="FeralCombat" && Me.HealthPercent <= Settings.Current.OOCRegrowth && Me.ManaPercentage > 15 && !Me.HaveBuff("Regrowth") && Me.HaveBuff("Rejuvenation"), RotationCombatUtil.FindMe),
