...
namespace AIO.Combat.Druid
{
    ...
    internal class SoloBalance : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Regrowth"), 1.1f, (s,t) => !Me.HaveBuff("Regrowth") && Me.HealthPercent < Settings.Current.SoloBalanceRegrowth, RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Healing Touch"), 1.2f, (s ,t) => Me.HealthPercent < Settings.Current.SoloBalanceHealingTouch, RotationCombatUtil.FindMe),
            new RotationStep(new RotationSpell("Regrowth"), 1.3f, (s,t) => !t.HaveBuff("Regrowth") && t.HealthPercent < Settings.Current.SoloBalanceRegrowth, RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationSpell("Healing Touch"), 1.4f, (s ,t) => t.HealthPercent < Settings.Current.SoloBalanceHealingTouch, RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationBuff("Innervate"), 1.5f, (s,t) => Me.IsInGroup && t.Name == RotationFramework.HealName && t.ManaPercentage < Settings.Current.Innervate, RotationCombatUtil.FindPartyMember),
            new RotationStep(new RotationBuff("Innervate"), 1.6f, (s,t) => Me.ManaPercentage <= Settings.Current.Innervate, RotationCombatUtil.FindMe),
            ...
            new RotationStep(new RotationSpell("Starfall"), 5f, RotationCombatUtil.Always, s=> BossList.isboss || (Me.IsInGroup && RotationCombatUtil.EnemyAttackingCountCluster(30) > 2 && Settings.Current.SoloBalanceUseStarfall), RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Force of Nature"), 6.5f, RotationCombatUtil.Always, s => BossList.isboss || (Me.IsInGroup && (RotationCombatUtil.EnemyAttackingCountCluster(30) >= Settings.Current.SoloBalanceAOETargets)), RotationCombatUtil.FindMe),
