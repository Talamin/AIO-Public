...
namespace AIO.Combat.Druid
{
    ...
    internal class SoloBalance : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Starfall"), 13.5f, (s,t) => (BossList.MyTargetIsBoss && t.HealthPercent > 25) || (RotationFramework.Enemies.Count(o => o.IsElite && o.Position.DistanceTo(t.Position) <= 33) >= 3 && Settings.Current.SoloBalanceUseStarfall), RotationCombatUtil.FindMe),
            ...
            new RotationStep(new RotationSpell("Force of Nature"), 15f, (s, t) => BossList.MyTargetIsBoss || (Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.IsElite) >= Settings.Current.SoloBalanceAOETargets), RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Insect Swarm"), 19f, (s, t) => !t.HaveMyBuff("Insect Swarm") && (t.Health > 45 || BossList.MyTargetIsBoss) && !Me.HaveBuff("Eclipse (Lunar)") && !Me.HaveBuff("Eclipse (Solar)"), RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Faerie Fire"), 20f, (s, t) => !t.HaveBuff("Faerie Fire") && BossList.MyTargetIsBoss, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Moonfire"), 21f, (s, t) => Settings.Current.SoloBalanceUseMoonfire && BossList.MyTargetIsBoss && !t.HaveMyBuff("Moonfire") && t.HealthPercent > 35 || !Settings.Current.SoloBalanceUseMoonfire && !t.HaveMyBuff("Moonfire") && t.HealthPercent >= 60 && !Me.HaveBuff("Eclipse (Lunar)") && !Me.HaveBuff("Eclipse (Solar)"), RotationCombatUtil.BotTarget),
