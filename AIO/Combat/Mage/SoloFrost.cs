...
namespace AIO.Combat.Mage
{
    ...
    internal class SoloFrost : BaseRotation
    {
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Polymorph"), 2.1f, (s,t) => Settings.Current.SoloFrostSheep 
            ...
            new RotationStep(new RotationSpell("Cone of Cold"), 7f, (s,t) => Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10 && o.Position.DistanceTo(Me.Position) <= 10) >= Settings.Current.SoloFrostAOEInstance && Settings.Current.SoloFrostUseAOE, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Blizzard"), 7f, (s,t) => Me.IsInGroup && RotationFramework.Enemies.Count(o => o.IsTargetingMeOrMyPetOrPartyMember && o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.SoloFrostAOEInstance && Settings.Current.SoloFrostUseAOE, RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Mirror Image"), 11f, (s,t) => (!Me.IsInGroup && RotationFramework.Enemies.Count() >= 3) || BossList.MyTargetIsBoss, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Icy Veins"), 12f, (s,t) => (!Me.IsInGroup && RotationFramework.Enemies.Count() >= 2) || BossList.MyTargetIsBoss, RotationCombatUtil.BotTarget),
            new RotationStep(new RotationSpell("Summon Water Elemental"), 13f, (s,t) => !Settings.Current.GlyphOfEternalWater && ((!Me.IsInGroup && RotationFramework.Enemies.Count() >= 2) || BossList.MyTargetIsBoss), RotationCombatUtil.BotTarget),
            ...
            new RotationStep(new RotationSpell("Fire Blast"), 17f, (s,t) => Me.ManaPercentage > Settings.Current.UseWandTresh  && t.HealthPercent < Settings.Current.SoloFrostFrostFireBlast && !t.HaveBuff("Frost Nova"), RotationCombatUtil.BotTarget),
