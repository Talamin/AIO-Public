...
namespace AIO.Combat.Mage
{
    ...
    internal class GroupFire : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Frost Nova"), 2f, (s,t) => t.CGetDistance() <= 6 , RotationCombatUtil.BotTargetFast, checkLoS: true),
            ...
            new RotationStep(new RotationSpell("Flamestrike"), 6f, (s,t) => Settings.Current.FlamestrikeWithoutFire && !t.CHaveMyBuff("Flamestrike") && RotationFramework.Enemies.Count(o => o.Position.DistanceTo(t.Position) <=10) >= Settings.Current.FlamestrikeWithoutCountFire && Settings.Current.UseAOE, RotationCombatUtil.BotTargetFast, checkLoS: true),
            ...
            new RotationStep(new RotationSpell("Fire Blast"), 14f, (s,t) =>Me.ManaPercentage > Settings.Current.UseWandTresh &&  t.CHealthPercent() < 10, RotationCombatUtil.BotTargetFast, checkLoS: true),
