...
namespace AIO.Combat.Mage
{
    ...
    internal class GroupFire : BaseRotation
    {
        ...
        protected override List<RotationStep> Rotation => new List<RotationStep> {
            ...
            new RotationStep(new RotationSpell("Scorch"), 9f, (s,t) => !t.HaveMyBuff("Improved Scorch") && Me.ManaPercentage > Settings.Current.UseWandTresh && TalentsManager.HaveTalent(2,11), RotationCombatUtil.BotTarget),
